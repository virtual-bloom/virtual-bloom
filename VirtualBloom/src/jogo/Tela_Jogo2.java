...
public class Tela_Jogo2 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Tela_Jogo2 window = new Tela_Jogo2();
	...
	private void initialize() {
		frame = new JFrame();
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(Tela_Jogo2.class.getResource("/resourses/Logo_Icon.png")));
		...
		lbFundo.setIcon(new ImageIcon(Tela_Jogo2.class.getResource("/resourses/Tela_Jogo.png")));
        ...
        parte.setIcon(new ImageIcon(Tela_Jogo2.class.getResource(imagem)));
	...
	private void verificarVitoria() {
		...
		if (venceu) {
		    ...
		    Tela_Jogo3 telaJogo3 = new Tela_Jogo3(); // Cria uma nova instância da Tela_Jogo1
		    telaJogo3.frame.setVisible(true);
		}
	    }
		 ...
		 private void reiniciarJogo() {
			 // Reseta as variáveis
			    tentativasErradas = 0;
			    palavra = "MARGARIDA"; // Ou você pode escolher uma nova palavra aleatória aqui
