...
public class Tela_Jogo1 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Tela_Jogo1 window = new Tela_Jogo1();
	...
	private void initialize() {
		frame = new JFrame();
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(Tela_Jogo1.class.getResource("/resourses/Logo_Icon.png")));
		...
		lbFundo.setIcon(new ImageIcon(Tela_Jogo1.class.getResource("/resourses/Tela_Jogo.png")));
        ...
        parte.setIcon(new ImageIcon(Tela_Jogo1.class.getResource(imagem)));
	...
	private void verificarVitoria() {
		...
		if (venceu) {
		    ...
		    Tela_Jogo2 telaJogo2 = new Tela_Jogo2(); // Cria uma nova instância da Tela_Jogo1
		    telaJogo2.frame.setVisible(true);
		}
	    }
		 ...
		 private void reiniciarJogo() {
			 // Reseta as variáveis
			    tentativasErradas = 0;
			    palavra = "TULIPA"; // Ou você pode escolher uma nova palavra aleatória aqui
